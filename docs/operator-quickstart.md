# Operator Quickstart — Activities of head offices

Shortest path from clone to a verified local dry-run for **ISIC 7010** (`cloud-itonami-isic-7010`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7010.git
cd cloud-itonami-isic-7010
```
...
- Blueprint governor key: `group-oversight-governor`
- Likely source path: `headoffice.governor.cljc`
