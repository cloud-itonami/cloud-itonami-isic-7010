...
This repository designs a forkable OSS business for head-office activities -- overseeing and administering other units of the same enterprise or group (strategic planning, budgeting, group-wide policy) -- run by a qualified, licensed operator so a community or
...
the physical domain work**. Here a document-courier robot moves physical unit-reporting packages between subsidiaries,
under an actor that proposes actions and an independent **Group Oversight Governor**
...
approval and audit evidence: finalizing a group budget/policy allocation.
...
The governed actor implementation (`HeadOffice-LLM` + `Group Oversight Governor` as
